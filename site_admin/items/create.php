...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $orderId          = (string)($_POST['orderId'] ?? '');               // text NOT NULL (empty string OK)
    ...
    $statid           = (string)($_POST['statid'] ?? '0');               // text NULL -> default "0" here
    ...
    // ---- Basic validation for required (NOT NULL) business fields ----
    ...
    // Auto-generate productDescription if left blank (product-color-model)
    if ($productDesc === '') {
        $productDesc = ($product_name ?: 'NX100') . '-' . ($color ?: '') . '-' . ($model ?: '');
    }

    // Auto-generate trackId if left blank (matches your Payment.php scheme)
    if ($trackId === '') {
    ...
    if (!$errors) {
        try {
            // Insert ALL columns except id and created_at
            ...
            $errors[] = 'Create failed: ' . e($e->getMessage());
        }
    }
}
?>
    ...
    <div class="card-body">
      ...
      <form method="post">
        ...
        <div class="row g-3">
          ...
          <div class="col-md-4">
            <label class="form-label">Track ID (auto if blank)</label>
            <input class="form-control" name="trackId" placeholder="AUTO">
          </div>
          <div class="col-md-4">
          ...
          <div class="col-md-8">
            ...
            <input class="form-control" name="productDescription" placeholder="auto: product-color-model if left blank">
          </div>
          <div class="col-md-2">
            <label class="form-label">Amount</label>
            <input class="form-control" name="amount" placeholder="e.g. 49999 or paise text">
          </div>
          <div class="col-md-2">
            <label class="form-label">Stat ID</label>
            <input class="form-control" name="statid" value="0" readonly>
          </div>
          ...
          <div class="col-md-6">
            ...
            <input class="form-control" name="referralCode">
          </div>
